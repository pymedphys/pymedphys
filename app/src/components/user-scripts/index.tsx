...
interface IAppUserScriptsProps {

}

interface IAppUserScriptsState extends Readonly<{}> {
...
export class AppUserScripts extends React.Component<IAppUserScriptsProps, IAppUserScriptsState> {
  subscriptions: Subscription[] = []
  editorSubscription: Subscription | undefined = undefined

  constructor(props: IAppUserScriptsProps) {
    super(props)
    this.state = {
      isPythonReady: false,
