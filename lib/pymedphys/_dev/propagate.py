...
def propagate_extras():
    ...
    deps = pyproject_contents["project"]["dependencies"]
    ...
    extras = tomlkit.item(
        extras, _parent=pyproject_contents["project"], _sort_keys=True
    )
    ...
    if pyproject_contents["project"]["optional-dependencies"] != extras:
        pyproject_contents["project"]["optional-dependencies"] = extras
