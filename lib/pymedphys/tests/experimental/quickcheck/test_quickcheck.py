...
def mock_socket_send(self):
    ...
    if message == b'SER\r\n':
        ...
        raw_string = 'MEASGET;INDEX-MEAS={};MD=[ID=1636992223;Date=2021-11-15;Time=16:03:43];WORK=[' \
...
@mock.patch.object(QuickCheck, 'socket_send', autospec=True)
class TestQcMethods(TestCase):

    def test_connect(self, socket_send):
