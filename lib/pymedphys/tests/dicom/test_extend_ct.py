...
def make_datasets(series_instance_uid, sop_instance_uids, slice_locations):
    initial_datasets = [
...
def test_extend_datasets():
    ...
    initial_datasets = make_datasets(
...
def test_out_of_order():
    ...
    expected_datasets = make_datasets(
