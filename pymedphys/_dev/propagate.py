...
def propagate_setup():
    subprocess.check_call("dephell deps convert", shell=True)
    subprocess.check_call("black setup.py", cwd=REPO_ROOT, shell=True)


def propagate_requirements():
    subprocess.check_call("poetry update pymedphys", shell=True)
    subprocess.check_call(
        "poetry export -E user -f requirements.txt --output requirements.txt",
        shell=True,
    )
