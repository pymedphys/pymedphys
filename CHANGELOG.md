...
<!--     pymedphys/lib/pymedphys/docs/release-notes.md -->
...
- Fix issue in some Windows environments where running `pymedphys gui` would
  not find the streamlit installation. [\_gui/**init**.py](https://github.com/pymedphys/pymedphys/blob/03ba546b603edcbaf7b2b33c6367146a95142d0d/pymedphys/_gui/__init__.py#L43)
...
- Gracefully reject ipython inspection for optional modules by returning `None`
  for '**file**' attribute requests for modules that are not currently
  installed.
