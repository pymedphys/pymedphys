...
def mephysto_absolute_depth_dose(absolute_dose, depth_of_absolute_dose_mm,
    ...
    interpolation = scipy.interpolate.interp1d(
        mephysto_pdd_depth, mephysto_dose)
...
def mephysto_absolute_profiles(curvetype, depth_test,
                               distance, relative_dose, scan_curvetype,
                               scan_depth, mephysto_pdd_depth,
                               mephysto_pdd_dose):

    choose_mephysto = (scan_curvetype == curvetype) & (
    ...
    mephysto_normalised_dose = normalise_profile(
        mephysto_distance, relative_dose[choose_mephysto][0],
        scale_to_pdd=True, pdd_distance=mephysto_pdd_depth,
        pdd_relative_dose=mephysto_pdd_dose, scan_depth=depth_test
    )
...
def absolute_scans_from_mephysto(mephysto_file, absolute_dose,
    ...
    mephysto_pdd_depth, mephysto_pdd_dose = mephysto_absolute_depth_dose(
        absolute_dose, depth_of_absolute_dose_mm,
        distance, relative_dose, scan_curvetype)
