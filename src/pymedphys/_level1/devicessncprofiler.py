...
def write_prs(x_prof, y_prof, file_name=None):
    ...
    prs_file = ['Version:\t 7\n',
                'Filename:\tC:\\SNC\\Profiler2\\PYMEDPHYS.prs\n',
                'Date:\t 11/10/2018\t Time:\t16:56:28\n',
                'Description:\t\n',
                'Institution:\t\n',
                'Calibration File:\tC:\\SNC\\Profiler2\\Factors\\0000000\\PYMEDPHYS.cal\n',
                '\tProfiler Setup\n', '\n', 'Collector Model:\tProfiler2\n',
                'Collector Serial:\t0000000 Revision:\tC\n',
